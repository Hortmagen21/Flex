    ...
    private fun getPosts():Collection<Post>{
        return listOf(
                Post(1,5,654,95, User(1,"Vlad","https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80",325,235),
                        ...
                        Comment(User(2,"DeLitX","https://images.pexels.com/photos/34950/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500",235,523),"sdfs"),
                ...
                Post(2,651,64,5, User(3,"Vilard","https://cdn.pixabay.com/photo/2013/07/21/13/00/rose-165819__340.jpg",467,26),
                        ...
                        Comment(User(4,"Hortmagen","https://media.gettyimages.com/photos/beautiful-book-picture-id865109088?s=612x612",6236,2636),"sddgsdigjofpdgsghsdgh"),
                        "Проверка кириллицы"),
